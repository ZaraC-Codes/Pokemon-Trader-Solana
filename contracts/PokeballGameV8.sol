 ...
 * CHANGELOG v1.8.0:
 * - NEW REVENUE SPLIT:
 *   - APE purchases: 0.5% APE stays in PokeballGame, 0.5% APE to SlabNFTManager, 99% converted to USDC.e (96% NFT pool + 3% treasury)
 *   - USDC.e purchases: 1% converted to APE (0.5% PokeballGame + 0.5% SlabNFTManager), 99% USDC.e (96% NFT pool + 3% treasury)
 * - APE RESERVE MANAGEMENT: Maintains minimum 0.5% APE reserve for Entropy fees and gas
 * - GASLESS THROWS: Players only sign ball purchases; throws use contract's APE reserve
 * - META-TRANSACTION SUPPORT: throwBallFor() allows relayer to execute throws on behalf of players
 *
 * Previous versions:
